 ...
 */
public class StaffEditDialogController1 {
     ...
     */
        ...
        subjectField1.setText("None");
        subjectField2.setText("None");
        }
        else{
    ...
    */
    ...
    private void handleOk() throws IOException {
	            ...
	            String subjectName = subjectField1.getText();
	            String subjectName1 = subjectField2.getText();
	            LocalDate joiningDate = joining.getValue();
	            String contactNo = contactField.getText();
	            String department = deptField.getText().substring(0, 1).toUpperCase() + deptField.getText().substring(1).toLowerCase();
	            ...
	            try{
	               ...
	               if(sc.isNewClicked()){
	       	       if (isInputValid()) {
	       	    	 ...
	       	    	 String sql = "INSERT INTO `sty`.`nonteachingstaff` (`id`, `firstName`,  `lastName`, "
	               ...
	               if(sc.isEditClicked()){
	   	        	...
	   	        	if (isInputValid()) {
	   	        		...
	   	        		String sql = "UPDATE `sty`.`nonteachingstaff` SET `firstName`="+"'"+firstName+"'"+","+
    ...
    private boolean isInputValid() {
        ...
        if (deptField.getText() == null || deptField.getText().length() == 0) {
